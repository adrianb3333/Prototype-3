...
const DRILL_TYPES = [
  { id: 'Power Line', label: 'Power Line', subLabels: ['5 Wood', '3 Wood', 'Driver'] },
  { id: 'The Fade', label: 'Fade', subLabels: ['5 Wood', '3 Wood', 'Driver'] },
  { id: 'The Draw', label: 'Draw', subLabels: ['5 Wood', '3 Wood', 'Driver'] },
  { id: 'Accuracy', label: 'Accuracy', subLabels: ['5 Wood, 235m', '3 Wood, 265m', 'Driver, 285m'] },
];
...
export default function WooData() {
    ...
    try {
      ...
      DRILL_TYPES.forEach((drill) => {
        ...
        const subDrills = drill.subLabels.map(subLabel => {
          ...
          return {
            name: subLabel.split(',')[0], // Clean label (e.g., "5 Wood")
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.sectionTitle}>Wood Performance</Text>
          ...
          >
            <View style={styles.mainRow}>
              ...
              <View style={styles.statsRow}>
                ...
                <View style={styles.statItem}>
                  <Text style={[styles.statLabel, { color: '#f2cc8f' }]}>BEST</Text>
                  <Text style={[styles.statValue, { color: '#f2cc8f' }]}>{drillData?.best ?? 0}</Text>
                </View>
              </View>
            </View>
                  ...
                  <View key={idx} style={styles.subDrillContainer}>
                    <View style={styles.subHeader}>
                      ...
                      <View style={styles.detailedStats}>
                        ...
                        <Text style={styles.detailText}>Best: <Text style={[styles.highlight, { color: idx === 0 ? '#8ecae6' : idx === 1 ? '#f2cc8f' : '#e07a5f' }]}>{sub.best}</Text></Text>
                      </View>
                    </View>
                    <View style={styles.barBackground}>
                      <View style={[styles.barFill, { 
                        width: `${(sub.score / 10) * 100}%`,
                        backgroundColor: idx === 0 ? '#8ecae6' : idx === 1 ? '#f2cc8f' : '#e07a5f'
                      }]} />
                    </View>
                  </View>
                ))}
